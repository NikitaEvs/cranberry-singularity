...
print(region.online)   # включена ли линия? (нет ли блэкаута?) 
...
print(psm.get_move())  # определить номер текущего хода (первый ход = 0) 
...
#### Биржа (накапливается)
psm.orders.trade0.buy(5)   # купить 5 МВт-ч на мгновенной бирже
psm.orders.trade0.sell(5)  # продать 5 МВт-ч на мгновенной бирже

psm.orders_lazy.trade1.buy(5)   # ... через 1 ход
psm.orders_lazy.trade3.buy(5)   # ... 3 хода
psm.orders_lazy.trade10.buy(5)  # ... 10 ходов
